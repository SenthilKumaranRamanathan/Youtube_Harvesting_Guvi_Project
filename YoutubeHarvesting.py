...
#st.markdown("<h1 style='color:DarkSlateGray'>Youtube Harvesting Application developed by SenthilKumaran Ramanathan </h1>", unsafe_allow_html=True)
st.markdown(
    """
    <div style="
        ...
        font-size: 30px;
    ">
        <p><b></b> <h3 style='color:DarkSlateGray'>YouTube Channel Data Analysis Application developed by SenthilKumaran Ramanathan.</h3></p>
    </div>
    """,
    unsafe_allow_html=True
)
...
DB_NAME = 'ytharvest' #' database_name'
DB_USER = 'ytharvest' #'username'
DB_PASSWORD = 'YhProj' #'password'
DB_HOST = 'localhost'
DB_PORT = '5432'
