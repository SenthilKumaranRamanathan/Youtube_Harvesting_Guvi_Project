...
- Options to filter results by specific criteria such as video likes and comments.
...
- Data is stored in:
  - A temporary data lake for immediate use.
...
4. Configure the Google API key in `.env` file:
   plaintext
...
1. Launch the application using the terminal command.
2. Enter a YouTube Channel URL in the provided input box.
3. Click "Fetch Data" to retrieve channel and video information.
4. Click "Save to Database" to store data in MySQL/PostgreSQL.
5. Use the Search tab to query the stored data using filters or SQL commands.
...
- Export retrieved data as CSV/Excel files.
